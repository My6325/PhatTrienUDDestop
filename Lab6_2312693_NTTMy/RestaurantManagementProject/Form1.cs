...
namespace RestaurantManagementProject
{
    public partial class Form1 : Form
    {
        ...
        private void LoadCategory()
        {
            ...
            cbbCategory.DataSource=listCategories;
        ...
        private void lsvFood_Click(object sender, EventArgs e)
        {
            for(int i = 0;i< lsvFood.Items.Count; i++)
            {
                if (lsvFood.Items[i].Selected)
                {
                    ...
                    cbbCategory.SelectedIndex=listCategories.FindIndex(x=>x.ID==foodCurrent.FoodCategoryID);
                }
            }
        }
        ...
        private void cmdAdd_Click(object sender, EventArgs e)
        {
            ...
            else MessageBox.Show("Thêm dữ liệu không thành công. Kiểm tra lại");
        }
        ...
        private void cmdUpdate_Click(object sender, EventArgs e)
        {
            ...
            if(result > 0)
            {
                MessageBox.Show("Cập nhật dữ lệu thành công");
                LoadFoodDataToListView();
            }
