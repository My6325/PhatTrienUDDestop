...
namespace Lab_Basic_Command
{
    public partial class AccountInfoForm : Form
    {
        ...
        {
            string connectionSting = ConfigurationManager.ConnectionStrings["Restaurant"].ConnectionString;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                string connetionString = ConfigurationManager.ConnectionStrings["Restaurant"].ConnectionString;
